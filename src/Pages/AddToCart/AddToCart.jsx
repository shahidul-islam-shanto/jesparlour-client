      ...
      <section className="container-2">
        <div className="grid gap-8 lg:grid-cols-12 lg:items-start">
          <div className="lg:col-span-8">
            ...
            <div className="mt-8 rounded-lg border border-nu30 bg-white p-5 shadow-xl sm:p-6">
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                    <div>
                      <h2 className="text-[24px] text-nu20">{title}</h2>
                      <p className="mt-3 text-nu40">{description}</p>
                    </div>
            ...
            <div className="rounded-lg border border-nu30 bg-white p-6 shadow-xl lg:sticky lg:top-24">
              ...
              <div className="mt-6 space-y-4 border-y border-nu30 py-6">
                <div className="flex items-center justify-between gap-4">
                  <p className="text-nu40">Service</p>
                  <p className="text-right font-semibold text-nu20">{title}</p>
                </div>
                <div className="flex items-center justify-between gap-4">
                  <p className="text-nu40">Subtotal</p>
                  <p className="font-semibold text-nu20">{price}</p>
                </div>
                <div className="flex items-center justify-between gap-4">
                  <p className="text-nu40">Total</p>
                  <p className="text-[28px] font-bold text-secondary1">{price}</p>
                </div>
              </div>
